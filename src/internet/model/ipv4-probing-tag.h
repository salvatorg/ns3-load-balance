#ifndef IPV4_PROBING_TAG_H
#define IPV4_PROBING_TAG_H
...
class Ipv4ProbingTag : public Tag
{
public:
    ...
    Ipv4Address GetProbeAddress (void) const;

    void SetProbeAddress (Ipv4Address address);

    uint16_t GetSrcNodeID (void) const;

    void SetSrcNodeID (uint16_t srcNodeID);
